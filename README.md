...
|----------------|-----------------|-----------------|
|[PIM проект](https://github.com/igor-turkin/pim_project)|Исследования снижения выкупа заказов e-commerce. Поиск инсайтов и причин отказов. Расчет продуктовых метрик (CR и пр). Расчет статистической значимости (t-test, Хи-квадрат). Визуализация чартов (seaborn) и дашборда(Datalens)|Python, Стат. методы, Продуктовые метрики, DataLens| 
...
|[Мои дашборды](https://github.com/igor-turkin/dashboards)|Демонстрационные дашборды. Сейчас я больше сконцентрирован на Power BI и Superset. Популярность Tableau у компаний очень сильно снизилась. DataLens многие еще не воспринимают всерьёз. |DataLens, Superset, Power BI, Tableau|
