...
|----------------|-----------------|-----------------|
|[A/B тест в таксопарке](https://github.com/igor-turkin/taxi_park))|Анализ результатов A/B теста новой механики мобильного приложения. Расчет продуктовых метрик. Расчет статистической значимости. Анализ системы сплитования A/A. Визуализации и презентация.|Python, Power BI| 
