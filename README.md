...
|----------------|-----------------|-----------------|
|[PIM проект](https://github.com/igor-turkin/pim_project)|Исследования снижения выкупа заказов e-commerce. Поиск инсайтов и причин отказов. Расчет продуктовых метрик (CR и пр). Расчет статистической значимости (t-test, Хи-квадрат). Визуализация чартов (Datalens)|Python, Стат. методы, Продуктовые метрики, DataLens| 
